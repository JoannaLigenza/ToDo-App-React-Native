...
import {StyleSheet, Text, View, TouchableOpacity, AsyncStorage, ScrollView, Modal, FlatList} from 'react-native';
...
export default class Main extends Component {
  ...
  render() {
    console.log('main 1 ', this.state.tasks.length)
    ...
    return (
      <View style={styles.mainComponent} >       
        ...
        <FlatList
            ...
            //CellRendererComponent={({index, children}) => {return <View style={{zIndex: this.state.isActive===index ? 10 : 1}}>{children}</View>}}
        />
        <View>
